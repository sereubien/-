<%@ page contentType="text/html;charset=utf8" import="java.sql.*,oracle.dbpool.*" %>
...
%>
		<tr>
			...
			<td  bgcolor=#ffffcc align=right width=70><fmt:formatNumber value="<%= price %>" pattern="#,###" />원</font></td>
			<td  bgcolor=#ffffcc align=right width=120><fmt:formatNumber value="<%= price*qty %>" pattern="#,###" />원</font></td>
		</tr>
<% } %>
	</table>
	<table align=center>
		<tr>
			...
			<td><%= pid %> 회원님이 구매하실 총수량은 [<%= totalqty %>개] 이고,  결제하실 금액은 [<fmt:formatNumber value="<%= totalprice %>" pattern="#,###" />원] 입니다</font></td>
		</tr>
	</table>
<%
	rs1.close();
